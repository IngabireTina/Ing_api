...
class ProfileTestClass(TestCase):
    def setUp(self):
        self.wanjiku = Profile( profile_photo='default.jpg',bio='hello you', website='www.tina.com', phone_number='078656443')
...
class RatesTestClass(TestCase):
    def setUp(self):
        self.user = User(username='ketty',email='ketty@gmail.com',password='tina12345')
